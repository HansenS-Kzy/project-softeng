  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <div className="glass-elevated rounded-2xl border border-white/[0.08] p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
        <ShieldCheck size={48} className="text-slate-500 mb-4 opacity-50" />
        <h2 className="text-xl font-bold text-white mb-2">User Management</h2>
        <p className="text-slate-400 max-w-md">The user management directory and roles settings will be accessible here.</p>
      </div>
    </motion.div>
  );
}
