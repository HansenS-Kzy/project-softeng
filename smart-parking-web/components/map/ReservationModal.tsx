...
import {
  X, Zap, Accessibility, Car, MapPin, Clock,
...
export default function ReservationModal({
  ...
  // Pastikan kendaraan pertama otomatis terpilih setelah data siap
  useEffect(() => {
  ...
  const handleReserve = async () => {
    ...
    try {
      ...
      const reservation = await createReservation({
        ...
        slotID: slot.slotID, // Tetap gunakan UUID untuk database backend
      ...
      setStep('success');
      addToast('success', 'Reservation Created', `Slot ${slot.coordinate} held for 1 hour.`);
    } catch {
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {/* MENGUBAH UUID JADI KOORDINAT NAMA */}
                <h2 className="text-2xl font-bold text-white tracking-wider">{slot.coordinate}</h2>
              </div>
            </div>
            <button
              onClick={onClose}
            ...
            {step === 'success' ? (
              ...
              >
                ...
                <p className="text-slate-400 text-sm mb-4">
                  Slot <strong className="text-white">{slot.coordinate}</strong> is held for 1 hour.
                </p>
                ...
                {step === 'select' && (
                  <div className="mb-6">
                    ...
                    <div className="flex flex-col gap-2">
                      {vehicles.length === 0 ? (
                        <div className="text-center p-4 border border-white/10 rounded-xl text-slate-400 text-sm">
                  ...
                  <div className="mb-6 glass rounded-xl p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        {/* MENGUBAH UUID JADI KOORDINAT NAMA */}
                        <span className="text-white font-mono font-bold text-lg">{slot.coordinate}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-white font-mono bg-white/10 px-2 rounded border border-white/20">{selectedVehicle.licensePlate}</span>
                      </div>
